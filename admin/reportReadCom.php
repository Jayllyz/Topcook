...
<div class="container">
        <div id="logs">
            <a href="https://topcook.site/admin/reportRead.php" class="btn mb-4">Recettes signalés</a>
            <a href="https://topcook.site/admin/reportReadMsg.php" class="btn ms-4 mb-4">Messages signalés</a>
